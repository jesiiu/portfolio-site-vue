...
export default {
  data() {
    return {
      ...
      serverItems: [
        {
          icon: 'vi-file-type-nginx',
          name: 'Nginx'
        },
        {
          icon: 'vi-file-type-apache',
          name: 'Apache'
        },
        {
          icon: 'fc-linux',
